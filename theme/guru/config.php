...
$string['choosereadme'] = 'Theme Guru is a child theme of Boost. It is fully customized to bring a simplified, clean but functional learning management system.';                
// The name of our plugin.                                                                                                          
$string['pluginname'] = 'Guru';        
...
// extensions.
$THEME->sheets = ['css', 'scss', 'theme-css'];
...
$THEME->scss = function($theme) {
    return theme_guru_get_main_scss_content($theme);
};
